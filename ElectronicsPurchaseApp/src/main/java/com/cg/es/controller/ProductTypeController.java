...
import com.cg.es.service.ProductTypeServiceImpl;
...
public class ProductTypeController {
	...
	public ResponseEntity<ElectronicProductType> addProduct(@RequestBody ElectronicProductType product){
	...
	public ResponseEntity<ElectronicProductType>updatetype(@RequestBody  ElectronicProductType product) throws Exception {
